...
import io.chatwallet.NativeModules.Haptics.RNHapticsPackage;
import io.chatwallet.NativeModules.Internals.InternalPackage;
import io.chatwallet.NativeModules.RNBip39.RNBip39Package;
import io.chatwallet.NativeModules.RNBackHandler.RNBackHandlerPackage;
import io.chatwallet.NativeModules.RNReview.RNReviewPackage;
import io.chatwallet.NativeModules.RNStartTime.RNStartTimePackage;
import io.chatwallet.NativeModules.RNTextAnimatorPackage.RNTextAnimatorPackage;
import io.chatwallet.NativeModules.RNZoomableButton.RNZoomableButtonPackage;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("io.chatwallet.ReactNativeFlipper");
        aClass
